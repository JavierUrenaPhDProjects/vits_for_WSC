...
class XCiT(Module):
    def __init__(
        ...
        self.xcit_transformer = XCATransformer(dim, depth, heads, dim_head, mlp_dim, local_patch_kernel_size, dropout,
                                               layer_dropout)
...
def xcit_nano12_p16(args):
    ...
    model = XCiT(
        ...
        num_classes=1,
        dim=hidden_dim,
        depth=depth,  # depth of xcit transformer
        cls_depth=1,  # depth of cross attention of CLS tokens to patch, attention pool at end
        heads=h,
        mlp_dim=mlp_dim,
...
def xcit_large24_p16(args):  # ESTE MODELO ES DEMASIADO GRANDE PARA SER ENTRENADO EN EL CLUSTER
